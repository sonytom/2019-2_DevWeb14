...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="/testeDevWeb12092019/resources/img/favicon.ico">

    <!-- Global Stylesheets -->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i" rel="stylesheet">
    <link href="/testeDevWeb12092019/resources/css/bootstrap/bootstrap.min.css" rel="stylesheet">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" ><a class="nav-link smooth-scroll" href="listaPrincipal">Home</a></li>
