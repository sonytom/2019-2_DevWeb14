   ...
   <body>
      ...
      <body id="page-top">
         ...
         <div id="home-p" class="home-p pages-head3 text-center">
            <div class="container">
               <h1 class="wow fadeInUp" data-wow-delay="0.1s">Fornecedores</h1>
            </div>
            <!--/end container-->
         </div>
                  ...
                  <tr>
                     ...
                     <td>
                        <button class="btn btn-warning btn-sm">
                           <a href="editaFornecedores?id=${fornecedor.id}" title="Editar">
                              <i class="fa fa-refresh"></i>
                        </button>
                     </td>
                     <td><button class="btn btn-danger btn-sm"><a href="removeFornecedor?id=${fornecedor.id}" title="Excluir"><i class="fa fa-trash-o"></i></a></button>
                     </td>
                  </tr>
               </c:forEach>
               <div class="col-md-12 float-left eigth-button mt-5">
                  <a href="novoFornecedor" class="btn float-left  btn-21">Novo Fornecedor</a> 
               </div>
               <br>
               </tbody>
            </table>
